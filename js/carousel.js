...
define(function(require,exports,module){
        function Carouse(options){
            ...
            var setting ={
                img_src : ["./images/1.jpg","./images/2.jpg","./images/3.jpg","./images/4.jpg"],//图片加载地址数组
                linkUrl:["https://github.com/","http://www.imooc.com","https://stackoverflow.com/","https://www.zhihu.com"],
                con:document.getElementById('con'),//图片加载容器
                speed:2500,//默认轮播速度
            }
            ...
            for(var i=0; i<setting.img_src.length; i++){
                ...
                aLink.href = setting.linkUrl[i];
                oImg.setAttribute("src",setting.img_src[i]);
                aLink.appendChild(oImg);
            ...
            /*进行图片预设*/
            var arrImg = setting.con.getElementsByTagName('img');
            changeImg(index,flag,setting);
            /*进行图片自动轮播*/
    ...
    function changeImg(index,flag,setting){
        flag==0?flag:flag=1;
        var contentImg = setting.con;
        var arrImg = contentImg.getElementsByTagName('img');
